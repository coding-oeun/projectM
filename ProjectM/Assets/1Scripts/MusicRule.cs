...
public class MusicRule : MonoBehaviour
{
    ...
    {
        // 음악 호출
        musicSource = GameObject.Find("Tagger").GetComponent<AudioSource>();
    ...
    {
        //술래 위치 업데이트
        taggerPos = tagger.transform.position;

        //술래&유저 거리체크
        dis = Vector3.Distance(vrManager.hmdCurrentPosCheck, taggerPos);
